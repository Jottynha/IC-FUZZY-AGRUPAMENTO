...
def clustering_kmeans(
	...
	# Construção do KMeans com parâmetros configuráveis para ajuste fino
	kmeans_kwargs = dict(
	...
	if algorithm is not None:
		kmeans_kwargs["algorithm"] = algorithm
...
def train_mamdani(
	...
	if save_model:
		...
		model_json = model_path or (output_tables_dir / "mamdani_model.json")
